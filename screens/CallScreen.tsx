...
/**
 * Web-safe stub for CallScreen.
 * Native implementation is in CallScreen.native.tsx
 */
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.message}>
          The Private Sanctuary is an immersive experience designed specifically for mobile hardware.
        </Text>
